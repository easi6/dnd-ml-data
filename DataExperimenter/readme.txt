...
================================
-DataLoader 
-run_DataLoader.sh (shell script run to temporarily set environment variables and execute 
                    the application)
   -to run the shell script, type
   
       ./run_DataLoader.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/R2010a/v716, run the shell script as:
       ...
       ./run_DataLoader.sh /mathworks/home/application/R2010a/v716
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_DataLoader.sh /mathworks/devel/application/matlab
-MCRInstaller.zip
...
A. Linux x86-64 systems:
   ...
   LD_LIBRARY_PATH by issuing the following commands:
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_DataLoader.sh 
